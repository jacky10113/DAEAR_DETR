...
#该程序实现将预测数据转换成caltech_eval程序需要的txt格式
gt_json = '/public/home/houjie/video_structure/buspassenger_detection/datasets/PedestrianDatasets/CaltechPedestrian/interval30/test.json'

result_jsons = glob.glob('./test_out/DAEAR-DETR_caltechPedestrian_interval30_epoch64_predictions.json')

print(result_jsons)
matlab_results_dir = './test_out/eval_caltech/'
...
image_names.sort()
print("imagesNum:%d"%len(image_names))
videos = {}
